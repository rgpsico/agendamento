...
class ReceitaRecorrenteApiController extends Controller
{
    /**
     * Listar receitas recorrentes (com filtros e total).
     */
    public function index()
    {
        $request = request();
        $query = ReceitaRecorrente::with(['usuario', 'categoria', 'empresa']);
    ...
    /**
     * Mostrar uma receita recorrente específica.
     */
    public function show($id)
    {
        $receita = ReceitaRecorrente::with(['usuario', 'categoria', 'empresa'])
            ->findOrFail($id);
    ...
    /**
     * Resumo financeiro de receitas recorrentes.
     */
