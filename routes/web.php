...
Route::prefix('crm')->middleware(['auth', 'tenant'])->name('crm.')->group(function () {
    ...
    Route::patch('leads/{lead}/whatsapp-status', [CRMLeadController::class, 'updateWhatsappStatus'])->name('leads.whatsapp-status');
...
Route::prefix('admin/agendamentos')->middleware(['auth'])->name('admin.agendamentos.')->group(function () {
    ...
    Route::get('chat/debug',     [AgendamentoChatController::class, 'debug'])->name('chat.debug');
});
