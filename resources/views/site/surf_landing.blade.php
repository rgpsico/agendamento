...
<head>
  ...
  <title>Teste Grátis — Sistema de Gestão para Escolas de Surf</title>
  <meta name="description" content="Gerencie sua escola de surf sem complicação. Agenda de aulas, cobranças e alunos em um só lugar. Teste grátis por 14 dias.">
  ...
  <style>
    *, *::before, *::after {
    ...
    :root {
      ...
      --gray-subtle: #e2e8f0;
      --radius:      14px;
      --shadow:      0 4px 24px rgba(14, 134, 200, 0.14);
    }
    ...
    input:focus {
      ...
      box-shadow: 0 0 0 3px rgba(14, 134, 200, 0.15);
      background: var(--white);
    }
    ...
    .btn-cta:hover {
      ...
      box-shadow: 0 8px 24px rgba(14, 134, 200, 0.38);
    }
  ...
  <main class="hero">
    <div class="hero-inner">
      ...
      <div class="hero-copy">
        ...
        <h1>
          Gerencie sua escola de surf
          <span>sem complicação</span>
        </h1>

        <p class="subtitle">
          Agenda de aulas, cobranças automáticas e controle de alunos — tudo em um só lugar.
          Configure em minutos e foque no que você faz de melhor: ensinar a surfar.
        </p>
        ...
        <div class="benefits">
          <div class="benefit-item">
            ...
            <div class="benefit-text">
              <strong>Agenda de aulas na praia</strong>
              <span>Alunos agendam sozinhos por horário e condição do mar.</span>
            </div>
          </div>
