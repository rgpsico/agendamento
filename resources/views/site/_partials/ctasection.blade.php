<section class="py-20 hero-gradient text-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10 text-center">
        <h2 class="text-4xl md:text-6xl font-bold mb-6 text-glow cta-title">
            {{ $site->cta_titulo ?? 'Pronto para Sua Primeira Aventura?' }}
        </h2>
        <p class="text-xl md:text-2xl mb-8 opacity-90 cta-subtitle">
            {{ $site->cta_descricao ?? 'Junte-se a centenas de pessoas que já viveram experiências inesquecíveis em nossos passeios.' }}
        </p>
