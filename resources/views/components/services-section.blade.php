    ...
    <div class="container mx-auto px-6">
        <div class="text-center mb-16 section-header">
            <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                {{ $site->titulo ?? 'Nossos Serviços de ' . ucfirst($modalidade) }}
            </h2>
                ...
                <div class="card-hover bg-white rounded-2xl overflow-hidden shadow-lg relative">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="https://wa.me/{{ preg_replace('/\D/', '', $site->whatsapp) }}?text=Olá! Gostaria de reservar o serviço: {{ $servico->titulo }}" 
                            target="_blank"
