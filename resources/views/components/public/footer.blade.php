                ...
                <div class="col-lg-3 col-md-4">
                    <div class="footer-widget footer-about">
                        ...
                        <div class="footer-about-content" style="color:#fff;">
                            <p style="color:#fff;">Estamos comprometidos em promover a paixão pelos esportes ao ar
                                livre, facilitando o
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="footer-widget footer-menu">
                        ...
                        <ul>
                            ...
                            <li><a style="color:#fff;" href="https://wa.me/5521990271287" target="_blank"
                        ...
                        <div class="social-icon mt-3">
                            <ul>
                                <li><a href="https://facebook.com" target="_blank" rel="noopener"><i
                                            class="fab fa-facebook" style="color:#fff;"></i></a></li>
                                <li><a href="https://instagram.com" style="color:#fff;" target="_blank"
                                        rel="noopener"><i class="fab fa-instagram " style="color:#fff;"></i></a></li>
                                <li><a href="https://twitter.com" target="_blank" style="color:#fff;" rel="noopener"><i
                                            class="fab fa-twitter" style="color:#fff;"></i></a></li>
                                <li><a href="https://linkedin.com" target="_blank" rel="noopener" style="color:#fff;"><i
