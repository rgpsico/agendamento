                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="cal-icon">
                                    <input type="text" id="nascimento" class="form-control datetimepicker" value="24-07-1983">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Cep</label>
                                <input type="text" id="cep" class="form-control" value="22434">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Rua</label>
                                <input type="text" id="rua" class="form-control" value="United States">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Cidade</label>
                                <input type="text" id="cidade" class="form-control" value="Miami">
                            </div>
                        </div>
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Estado</label>
                                <input type="text"  id="estado" class="form-control" value="Florida">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Numero</label>
                                <input type="text" id="numero" class="form-control" value="Florida">
                            </div>
                        </div>
