<x-admin.layout title="Criar Serviço de Bot">
    <div class="page-wrapper">
        <div class="content container-fluid" style="padding: 2rem">

            <!-- Page Header -->
            <x-header.titulo pageTitle="Criar Serviço de Bot"/>
            <!-- /Page Header -->

            <x-alert/>

            <form action="{{ route('admin.botservice.store') }}" method="POST" class="needs-validation" novalidate>
                @csrf
                ...
                <div class="card shadow-lg border-0 mb-4">
                    <div class="card-header bg-gradient-primary text-white py-3">
                        <div class="d-flex align-items-center">
                            ...
                            <h5 class="card-title mb-0 fw-bold">Informações do Serviço de Bot</h5>
                        </div>
                    </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-text">
                                    ...
                                    Escolha o bot que irá gerenciar este serviço
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg px-4 shadow-sm">
                                    <i class="fas fa-save me-2"></i>Criar Serviço
                                </button>
                            </div>
                        </div>
                    </div>
