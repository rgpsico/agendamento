<x-admin.layout title="Criar Bot">
    <div class="page-wrapper">
        <div class="content container-fluid" style="padding: 5%">

            <!-- Page Header -->
            <x-header.titulo pageTitle="Criar Bot"/>
            <!-- /Page Header -->

            <x-alert/>

            <form action="{{ route('admin.bot.store') }}" method="POST">
                @csrf
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="tom" name="tom" class="form-control" value="{{ old('tom') }}">
                        </div>

                        <div class="mb-3">
                            <label for="token_deepseek" class="form-label">Token DeepSeek</label>
                            <input type="text" id="token_deepseek" name="token_deepseek" class="form-control" value="{{ old('token_deepseek') }}">
                        </div>

                        <div class="form-check mb-3">
                            <input type="checkbox" id="status" name="status" class="form-check-input" value="1" {{ old('status') ? 'checked' : '' }}>
