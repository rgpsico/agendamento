                ...
                <div class="col-12">
                    <div class="card modern-card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="site-config-form" action="{{ route('admin.site.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-section modern-section">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="titulo" id="titulo" value="{{ old('titulo') }}" class="form-control modern-input">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" name="whatsapp" id="whatsapp" value="{{ old('whatsapp') }}" class="form-control modern-input" placeholder="+55 21 99999-9999">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="descricao" id="descricao" class="form-control modern-textarea" rows="4">{{ old('descricao') }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="modern-checkbox">
                                            <input type="checkbox" name="atendimento_com_whatsapp" id="atendimento_com_whatsapp" class="form-check-input" {{ old('atendimento_com_whatsapp') ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <div class="modern-checkbox">
                                            <input type="checkbox" name="atendimento_com_ia" id="atendimento_com_ia" class="form-check-input" {{ old('atendimento_com_ia') ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group color-group">
                                                <label for="cores[primaria]" class="form-label">
                                                    <i class="fas fa-circle me-1" style="color: {{ old('cores.primaria', '#0ea5e9') }}"></i>
                                                    Cor Primária
                                                </label>
                                                <div class="color-wrapper">
                                                    <input type="color" name="cores[primaria]" id="cores_primaria" value="{{ old('cores.primaria', '#0ea5e9') }}" class="form-control form-control-color modern-color">
                                                    <span class="color-value">{{ old('cores.primaria', '#0ea5e9') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group color-group">
                                                <label for="cores[secundaria]" class="form-label">
                                                    <i class="fas fa-circle me-1" style="color: {{ old('cores.secundaria', '#38b2ac') }}"></i>
                                                    Cor Secundária
                                                </label>
                                                <div class="color-wrapper">
                                                    <input type="color" name="cores[secundaria]" id="cores_secundaria" value="{{ old('cores.secundaria', '#38b2ac') }}" class="form-control form-control-color modern-color">
                                                    <span class="color-value">{{ old('cores.secundaria', '#38b2ac') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-section modern-section">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sobre_titulo" id="sobre_titulo" value="{{ old('sobre_titulo') }}" class="form-control modern-input">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="sobre_descricao" id="sobre_descricao" class="form-control modern-textarea" style="min-height: 300px;">{{ old('sobre_descricao') }}</textarea>
                                    </div>
                                    ...
                                    <div id="servicos-container" class="dynamic-container">
                                        ...
                                        @foreach($servicos as $index => $servico)
                                            <div class="dynamic-item">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <input type="text" name="servicos[{{ $index }}][titulo]" class="form-control mb-2 modern-input" placeholder="Título do Serviço" value="{{ $servico['titulo'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="input-group">
                                                            <span class="input-group-text">R$</span>
                                                            <input type="number" step="0.01" name="servicos[{{ $index }}][preco]" class="form-control modern-input" placeholder="Preço" value="{{ $servico['preco'] ?? '' }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <textarea name="servicos[{{ $index }}][descricao]" class="form-control mb-2 modern-textarea" placeholder="Descrição do Serviço">{{ $servico['descricao'] ?? '' }}</textarea>
                                                <div class="upload-wrapper">
                                ...
                                <div class="form-section modern-section">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="dominio_personalizado" id="dominio_personalizado" value="{{ old('dominio_personalizado') }}" class="form-control modern-input" placeholder="dominio.com.br">
