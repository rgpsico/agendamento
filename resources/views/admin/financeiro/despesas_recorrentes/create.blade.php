<x-admin.layout title="Nova Despesa Recorrente">
    <div class="page-wrapper">
        <div class="content container-fluid" style="padding: 5%">

            <x-header.titulo pageTitle="Nova Despesa Recorrente"/>
            <x-alert/>

            <div class="card shadow">
                <div class="card-body">
                    <form action="{{ route('financeiro.despesas_recorrentes.store') }}" method="POST">
                        @csrf
