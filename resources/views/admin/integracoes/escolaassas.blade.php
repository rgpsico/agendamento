                                ...
                                @if(Auth::user()->professor && Auth::user()->professor->asaas_wallet_id)
                                    <div class="alert alert-success" role="alert">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-primary ms-2" onclick="copiarTexto('{{ Auth::user()->professor->asaas_wallet_id }}')">Copiar</button>
                                        </p>
                                    </div>
                                @else
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control" required value="{{ Auth::user()->nome ?? '' }}">
                                                <small class="form-text text-muted">Nome completo como no documento</small>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <small class="form-text text-muted">Email válido para receber notificações</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="cpfCnpj" id="cpfCnpj" class="form-control" required maxlength="11">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="phone" id="phone" class="form-control" required value="{{ Auth::user()->telefone ?? '' }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="mobilePhone" id="mobilePhone" class="form-control" required value="{{ Auth::user()->telefone ?? '' }}">
                                                <small class="form-text text-muted">Ex: 11987654321</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" name="birthDate" id="birthDate" class="form-control" required value="{{ Auth::user()->data_nascimento ? Auth::user()->data_nascimento->format('Y-m-d') : '' }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="incomeValue">Renda Mensal *</label>
                                                <input type="number" name="incomeValue" id="incomeValue" class="form-control" required step="0.01" min="0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="addressNumber" id="addressNumber" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <small class="form-text text-muted">Apartamento, sala, etc. (opcional)</small>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="postalCode" id="postalCode" class="form-control" required maxlength="8">
    ...
    <script>
        ...
        document.getElementById('integrarBtn').addEventListener('click', function() {
            ...
            if (gatewayName === 'asaas') {
                ...
                const requiredFields = ['name', 'email', 'cpfCnpj', 'phone', 'mobilePhone', 'birthDate', 'incomeValue', 'address', 'addressNumber', 'province', 'postalCode'];
                const missingFields = [];
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        copiarWallet.style.display = data.data.professor.asaas_wallet_id ? 'inline-block' : 'none';
