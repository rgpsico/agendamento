                ...
                <div class="tab-content" id="registerTabContent">
                    ...
                    <div class="tab-pane fade show active" id="aluno" role="tabpanel" aria-labelledby="aluno-tab">
                        <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-focus">
                                <input type="text" class="form-control floating @error('nome') is-invalid @enderror" id="alunoNome" name="nome" value="{{ old('nome') }}" required>
                            ...
                            <div class="form-group form-focus">
                                <input type="email" class="form-control floating @error('email') is-invalid @enderror" id="alunoEmail" name="email" value="{{ old('email') }}" required>
                            ...
                            <div class="form-group form-focus">
                                <input type="password" class="form-control floating @error('senha') is-invalid @enderror" id="alunoSenha" name="senha" required>
                    ...
                    <div class="tab-pane fade" id="professor" role="tabpanel" aria-labelledby="professor-tab">
                        <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group form-focus">
                                <input type="text" class="form-control floating @error('nome') is-invalid @enderror" id="professorNome" name="nome" value="{{ old('nome') }}" required>
                                <label class="focus-label">Nome</label>
                                @error('nome')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="form-group form-focus">
                                <input type="email" class="form-control floating @error('email') is-invalid @enderror" id="professorEmail" name="email" value="{{ old('email') }}" required>
                                <label class="focus-label">E-mail</label>
                                @error('email')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="form-group form-focus">
                                <input type="password" class="form-control floating @error('senha') is-invalid @enderror" id="professorSenha" name="senha" required>
                                <label class="focus-label">Senha</label>
                                @error('senha')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="form-group form-focus">
                                ...
                                <select name="modalidade_id" class="form-control @error('modalidade_id') is-invalid @enderror" id="professorModalidade" required>
                            ...
                            <button type="submit" class="btn btn-primary w-100 btn-lg">Cadastrar como Professor</button>
                            <div class="login-or">
                                <span class="or-line"></span>
                                <span class="span-or">Ou</span>
                            </div>
