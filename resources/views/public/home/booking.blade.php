<x-public.layout title="HOME">
  ...
  <style>
    ...
    .card_servicos:nth-child(1) { animation-delay: 0.1s; }
    .card_servicos:nth-child(2) { animation-delay: 0.2s; }
    .card_servicos:nth-child(3) { animation-delay: 0.3s; }
    .card_servicos:nth-child(4) { animation-delay: 0.4s; }
          ...
          <div class="card-body">
            <div class="booking-doc-info d-flex flex-column flex-md-row align-items-center">
              <a href="" class="booking-doc-img mb-3 mb-md-0 me-md-4">
                ...
                @else
                  <img src="https://fastly.picsum.photos/id/553/536/354.jpg?hmac=_eKSdchYCZH98R5ND5JJCACG421CpRVSdNfRH3sMmpY" class="img-fluid usuario-img" alt="Usuario Image">
                @endisset
              </a>
              <div class="booking-info text-center text-md-start">
                ...
                <p class="text-muted mb-0 mt-2">
                  <i class="fas fa-map-marker-alt me-2"></i> {{ $model->endereco->cidade ?? '' }}, {{ $model->endereco->pais ?? '' }}
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="submit-section">
      <div class="container">
        <div class="proceed-btn text-end mt-4">
          @if(Auth::check())
            <a href="{{ route('home.checkoutAuth', ['user_id' => $model->user_id]) }}" class="btn btn-primary submit-btn disabled">
              <i class="fas fa-calendar-check me-2"></i>Agendar e Pagar
            </a>
          @else
            <a href="{{ route('home.checkout', ['id' => $model->user_id]) }}" class="btn btn-primary submit-btn disabled">
              <i class="fas fa-calendar-check me-2"></i>Agendar e Pagar
            </a>
          @endif
        </div>
