    ...
    <div class="main-wrapper">
        <div class="register-box">
            <div class="row">
                ...
                <!-- Área da Logo -->
                <div
                    class="col-12 col-md-6 col-sm-12 login-left d-flex align-items-center justify-content-center teste">
                    ...
                    <div class="login-right-wrap">
                        ...
                        <form action="{{ route('user.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="modalidade_id"
                                    class="form-control @error('modalidade_id') is-invalid @enderror" id="modalidade_id"
                                    required>
                        ...
                        <div class="col-12 text-center">
                            <a href="{{ route('prof.login.google') }}" class="btn-google">
                                <i class="fab fa-google"></i> Registrar com Google aaa
                            </a>
                        </div>
                    </div>
                </div>
